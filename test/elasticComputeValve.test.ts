...
describe('ElasticComputeValve', () => {
    ...
    it('should preserve EHVI results through the adaptive valve', async () => {
    ...
    it('should encode valve workloads into transferable binary envelopes', () => {
